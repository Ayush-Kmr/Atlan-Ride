...
export class DriverComponent {
  ...
  countrycodeArray: string[] = ['+1', '+44', '+91', '+81', '+61']; // Add your desired country codes here
  isEditMode: boolean = false;
  citiesname: { _id: number; city: string }[] = [
    { _id: 1, city: 'New York' },
    { _id: 2, city: 'Los Angeles' },
    { _id: 3, city: 'Chicago' },
    { _id: 4, city: 'Houston' },
    { _id: 5, city: 'Delhi' } // Changed from 'India' to 'Delhi' for more specificity
  ];  
  selectedCity: any;
  file: any;
  driverArray: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.driverForm = this.formBuilder.group({
      ...
      driverphone: ["Delhi", [Validators.required, Validators.minLength(10)]],
      city: ["", [Validators.required]], // Default value removed to enforce selection
      status: [""],
    });
  ...
  onSelectedCity(value: any) {
    ...
    console.log('Selected City ID:', value); // This should show the selected city ID in the console.
  }
  // -----------------------DRIVER PROFILE---------------------------
